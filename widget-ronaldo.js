(function () {
    // Guard: script colado 2x no painel nao pode duplicar o provador (caso Liuzzi)
    if (window.__PL_RONALDO_LOADED__) return;
    window.__PL_RONALDO_LOADED__ = true;
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=ronaldo';
                a.target = '_blank';
                a.rel = 'noopener';
    ...
    // ===============================================
    const apiKey = "pl_live_c5101fe5db3e10ee15b4189cb009f833ef10d56af7ae79f9403873fd873e7221";
    window.PROVOU_LEVOU_API_KEY = apiKey;

    const WEBHOOK_PROVA = 'https://n8n.segredosdodrop.com/webhook/gerador-oculos';
    // PIX não configurado pra Ronaldo (webhooks de PIX abaixo não existem de propósito):
...
/* PL: borda arredondada do modal */@media(min-width:768px){.q-card-ia,.q-card,#q-card-ia,#q-card,.q-modal-card{border-radius:16px !important;overflow:hidden;}}
        ...
        :root {
            ...
            --c-accent: #111111;
            --c-accent-2: #333333;
            --c-grad: linear-gradient(135deg, #000000 0%, #333333 100%);
            --c-danger: #cc3333;
            ...
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-header-provador">
                        ...
                        <img src="https://ronaldooculos.com.br/wp-content/uploads/2026/06/WhatsApp_Image_2024-02-01_at_17.29.49-e1707225671203-Photoroom-1.png" alt="Ronaldo Óculos" style="height:64px;width:auto;"/>
                    </div>
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=ronaldo" target="_blank" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=ronaldo" target="_blank" class="q-powered-footer">
                    <span>Powered by</span>
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone, loja: 'ronaldo', origin: location.origin })
                    });
                    pix = await resp.json();
...
const fd = new FormData();
                    ...
                    console.log('[PL Ronaldo] Enviando', allProdImgs.length, 'fotos do produto');
